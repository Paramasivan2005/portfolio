        ...
        <div className="flex flex-col px-5 md:w-7/10 mx-auto py-3 text-center">
          ...
          <p className="mx-auto pt-1 text-slate-600 dark:text-gray-300">
            <center>
              ...
              building responsive, user-friendly, and secure web applications. I
              enjoy working with React, Node.js, Express, PostgreSQL, and
              continuously learning new technologies to solve real-world
              problems.
            </center>
          </p>
        </div>
